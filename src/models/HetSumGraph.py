...
from models.GAT import WSWGAT
from models.SentenceEncoder import sentEncoder
from models.PositionEmbedding import get_sinusoid_encoding_table
...
class HSumGraph(nn.Module):
     ...
     def forward(self, graph):
          ...
          # result = self.wh(sent_state) # No need to do classification
